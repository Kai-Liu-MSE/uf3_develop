...
def main():
    ...
    parser.add_argument('-o', '--output', default=None,
                        help="Output UF3 LAMMPS potential filename "
                             "(default: concatenated element symbols + .uf3)")
    ...
    uf3_lammps_pot_name = args.output or "".join(chemical_sys.element_list)+".uf3"
